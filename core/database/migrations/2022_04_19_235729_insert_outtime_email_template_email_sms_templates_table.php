...
class InsertOuttimeEmailTemplateEmailSmsTemplatesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
     public function up()
     {
         DB::table('email_sms_templates')->insert([
                 [
                     'act' => 'OUT_TIME_INFO_EMPLOYER',
                     'name' =>'Out Time Info Employer',
                     'subj' => 'Out time information of candidate',
                 ...
                 [
                     'act' => 'OUT_TIME_INFO_ADMIN',
                     'name' =>'Out Time Info Admin',
                     'subj' => 'Out time information of candidate',
