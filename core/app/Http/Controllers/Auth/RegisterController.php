...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        return $this->registered($request, $user)
            ? redirect()->route('user.profile.setting')->withNotify($notify):redirect($this->redirectPath());
    }
    ...
    {
        $users_data = User::select('employee_id')->latest()->first();
        $employee_id = 10000;
        if(!empty($users_data->employee_id))
        {
          $employee_id = $users_data->employee_id + 1;
        }
        $general = GeneralSetting::first();
        $user = new User();
