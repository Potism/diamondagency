...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $general->tax_rate = $request->tax_rate;
    ...
    {
        $pageTitle = 'Tax & Markup Fee for Temp Job';
        $general = GeneralSetting::first();
        return view('admin.setting.tax_markup', compact('pageTitle', 'general'));
    }

    public function taxMarkupUpdate(Request $request)
    {
        $general = GeneralSetting::first();
        $general->tax_rate = $request->tax_rate;
        $general->temp_markup_rate = $request->temp_markup_rate;
        $general->save();
        $notify[] = ['success', 'Tax & Temp job Rate updated.'];
        return back()->withNotify($notify);
    }
