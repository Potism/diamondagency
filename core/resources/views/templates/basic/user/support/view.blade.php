                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-8">
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group pt-md-3 mt-2">
                                                <a href="javascript:void(0)" class="btn px-2 py-1 mt-md-4 btn--primary addFile">
                                ...
                                <div class="col-md-3 text-end pt-3">
                                    <button type="submit" class="btn btn-sm btn--success mt-md-4">
