                                ...
                                <table class="table custom--table">
                                    ...
                                    <tbody>
                                        @foreach($supports as $key => $support)
                                            <tr>
                                                <td data-label="@lang('Subject')"> <a href="{{ route('ticket.view', $support->ticket) }}" class="font-weight-bold" style="width:70%;"> [@lang('Ticket')#{{ $support->ticket }}] {{ __($support->subject) }} </a></td>
                                                ...
                                                <td data-label="@lang('Action')">
                                                    <a href="{{ route('ticket.view', $support->ticket) }}" class="icon-btn" data-toggle="tooltip" title="View Ticket">
