                                ...
                                @forelse($logs as $log)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Employer')">
                                            @if($log->employer_id && isset($log->employer))
                                                <span class="font-weight-bold">{{ $log->employer->company_name }}</span>
                                                    <br>
                                                <span class="small">
                                                    <a href="{{ route('admin.employers.detail', $log->employer_id) }}"><span>@</span>{{ $log->employer->username }}</a>
                                                </span>
                                            @else
                                                <span>@lang('N/A')</span>
                                            @endif
                                        ...
                                        <td data-label="@lang('Action')">
                                            ...
                                            @elseif($log->employer_id)
                                                 <a href="{{ route('admin.employers.email.details',$log->id) }}" class="icon-btn btn--primary" target="_blank"><i class="fas fa-desktop"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
