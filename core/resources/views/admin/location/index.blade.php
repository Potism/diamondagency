            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.location.store')}}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="city" class="form-control-label font-weight-bold">@lang('Province')</label>
                            <select class="form-control form-control-lg" id="city" name="city" required="">
                                <option>@lang('Select Province')</option>
...
@push('breadcrumb-plugins')
    <a href="javascript:void(0)" class="btn btn-sm btn--primary box--shadow1 text--small addLocation" ><i class="fa fa-fw fa-paper-plane"></i>@lang('Add New City')</a>
@endpush
