                            ...
                            @foreach($section->element as $k => $type)
                                @if($k != 'modal')
                                    ...
                                    @elseif($type == 'textarea-nic')
                                        ...
                                        <div class="form-group @if(inputTitle($k) == 'Answer') answer_div @endif">
                                            <label>{{__(inputTitle($k))}}</label>
                                            <textarea rows="@if(inputTitle($k) == 'Answer'){{10}}@else{{4}}@endif" class="form-control nicEdit" placeholder="{{__(inputTitle($k))}}" name="{{$k}}"></textarea>
                                        </div>
    ...
    <script>
        (function ($) {
            ...
            $('.updateBtn').on('click', function () {
                ...
                $.each(obj, function (index, value) {
                    if(index == 'answer')
                    {
                        ...
                        modal.find('.nicEdit-main').html(value);
                    }
                    else
                    {
                        modal.find('[name=' + index + ']').val(value);
            ...
            $('#updateBtn').on('shown.bs.modal', function (e) {
                ...
                if($('#updateBtn .answer_div').length == 1)
                {
                  $('#updateBtn .answer_div').children("div").css('width','100%');
                  $('#updateBtn .answer_div div.nicEdit-main').css('width','100%');
                  $('#updateBtn .answer_div div.nicEdit-main').css('min-height','180px');
                }
            });
            $('#addModal').on('shown.bs.modal', function (e) {
                $(document).off('focusin.modal');
                if($('#addModal .answer_div').length == 1)
                {
                  $('#addModal .answer_div').children("div").css('width','100%');
                  $('#addModal .answer_div div.nicEdit-main').css('width','100%');
                  $('#addModal .answer_div div.nicEdit-main').css('min-height','180px');
                }
            });
