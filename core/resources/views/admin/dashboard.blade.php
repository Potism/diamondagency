    ...
    <div class="row mb-none-30">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--11 b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$employer['total_employer']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Employer')</span>
                    </div>

                    <a href="{{route('admin.employers.all')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$employer['verified_employer']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Verified Employer')</span>
                    </div>

                    <a href="{{route('admin.employers.active')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row mb-none-30">
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--info text-white">
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{$other['job']}}</h2>
                            <p class="text--small">@lang('Total Job')</p>
                            <h2 class="numbers text-white"><br>{{$other['job_running']}}</h2>
                            <p class="text--small">@lang('Total Running Job')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            <h2 class="numbers">{{$other['job_pending']}}</h2>
                            <p class="text--small">@lang('Pending Job')</p>
                        </div>
                    </div><!-- widget-two end -->
                </div>
            </div>
    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$other['job']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Job')</span>
                    </div>
                    <a href="{{route('admin.manage.job.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$other['category']}}</span>
                    </div>
                    <div class="desciption">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--12 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$invoices}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Invoices Issued')</span>
                    </div>

                    <a href="{{route('admin.invoice.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--6 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$low_balance}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Low Balance Employers')</span>
                    </div>

                    <a href="{{route('admin.invoice.lowbalance')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
    </div>
...
<a href="https://diamondagency.ca/" target="_blank" class="btn @if(Carbon\Carbon::parse($general->last_cron_run)->diffInSeconds()<600)
